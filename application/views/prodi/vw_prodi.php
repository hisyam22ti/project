<main>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12"><a href="<?= base_url('index.php/') ?>Prodi/tambah" class="btn btn-info mb-2">Tambah
                    Prodi</a>
                <div class="col-md-12">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($prodi as $us): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('index.php/Prodi/hapus/') . $us['id']; ?>"class="btn btn-danger">Hapus</a>
