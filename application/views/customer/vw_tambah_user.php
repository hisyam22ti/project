            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="nama_kacustomer">Nama Kacustomer</label>
                            <input type="text" name="nama_kacustomer" value="<?= set_value('nama_kacustomer'); ?>" class="form-control" id="nama_kacustomer" placeholder="Nama Kacustomer">
                            <?= form_error('nama_kacustomer', '<small class="text-danger pl-3">','</small>'); ?>
                        </div>
                        <div class="form-group">
